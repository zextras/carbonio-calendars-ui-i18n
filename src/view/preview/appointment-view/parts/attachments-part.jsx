...
export default function AttachmentsPart({ message, attachments }) {
	...
	return attachmentsCount > 0
		&& (
			...
			>
				...
				>
					<Icon icon="Attach" style={{ paddingRight: '8px' }} />
					<Text weight="bold">
						{' '}
						{t('Attachments')}
						{' '}
					...
					<IconButton icon={expanded ? 'ChevronUp' : 'ChevronDown'} onClick={toggleExpanded} size="small" />
				</Row>
				{
					expanded && (
